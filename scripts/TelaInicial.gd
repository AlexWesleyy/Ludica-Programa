...
@onready var descricao_scr: TextureRect = $Control/Jogo/ColorRect2/TextureRect
...
@onready var TutorialBreakContinue: ColorRect = $Control/TutorialBreakContinue
@onready var TutorialBreakContinueExec: ColorRect = $Control/TutorialBreakContinueExec
...
func _ready():
	...
	TutorialBreakContinue.hide()
	TutorialBreakContinueExec.hide()
	TutorialMatriz.hide()
...
func load_quiz() -> void:
	...
	descricao_scr.texture = current_quiz.question_script
...
func _on_voltar_while_exec_pressed():
	TutorialBreakContinue.show()
	TutorialBreakContinueExec.hide()
	pass # Replace with function body.
	
func _on_voltar_while_exec_BC_pressed():
	TutorialBreakContinue.hide()
	TutorialWhileExec.show()
	pass # Replace with function body.
...
func _on_proximo_tutorial_while_exec_pressed():
	TutorialBreakContinue.hide()
	TutorialBreakContinueExec.show()
	pass # Replace with function body.
	
func _on_proximo_BC_pressed():
	TutorialWhileExec.hide()
	TutorialBreakContinue.show()
	pass # Replace with function body.
...
#proximo while exec
func _on_Tutoria_matriz_bcExec():
	TutorialBreakContinueExec.hide()
	TutorialMatriz.show()
	pass # Replace with function body.
...
func _on_voltar_tutorial_acabado():
	TutorialMatrizExec.show()
	TutorialAcabado.hide()
	pass # Replace with function body.
